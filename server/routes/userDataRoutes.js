...
router.post('/removeCommentFromMyComments', userDataController.removeCommentFromMyComments)
router.post('/removeCommentFromApprovedComments', userDataController.removeCommentFromApprovedComments)
