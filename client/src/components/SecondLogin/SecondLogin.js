        ...
        <div className='container'>
            ...
            <div className="container2">
                ...
                <div className="comments" id='new'>
                    ...
                    <button id='check'><a className='fa fa-check-circle' style={{marginRight:'60%'}} ></a></button>
                    <button id='check'><a className='fa fa-times-circle' style={{marginRight:'60%'}} ></a></button>
                </div>
            </div>
