                ...
                <div className="overflow-x-hidden w-screen flex flex-col overflow-clip lg:-mt-24 mt-0">
                    <div className='flex flex-col overflow-x-hidden'>
                        <div className='flex flex-col lg:flex-row w-full justify-around items-center lg:mb-8 lg:h-screen h-[150vh]'>
                            <div className='w-4/5 lg:w-2/5 lg:mt-0 mt-8 border-2 lg:h-3/5 h-2/5 rounded-xl flex flex-col items-start justify-center relative'>
                                <div className='text-white font-bold uppercase text-4xl lg:text-5xl lg:text-left lg:pl-4 mt-8 text-center lg:mr-4'><motion.h3>WELCOME TO THE YEARBOOK PORTAL '23 OF IIT INDORE ...</motion.h3></div>
                    ...
                    <div className='w-full'>
                        ...
                        <div className='flex flex-col lg:flex-row mt-2'>
                            ...
                            <motion.div
                                ...
                                <img className='w-full h-full object-contain rounded-xl border-2' src={Step_1}></img>
                            </motion.div>
                            <motion.div
                                viewport={{ once: true }}
                                initial={{ opacity: 0, x: 100 }}
                    ...
                    <div className='w-full'>
                        <div className='flex lg:flex-row flex-col mt-4 items-start'>
                            ...
                            <motion.div
                                ...
                                <img className='w-full h-full object-cover rounded-xl' src={Step_3}></img>
                            </motion.div>
                        </div>
                            ...
                            <div className='flex flex-col'>
                                <div className='flex lg:flex-row flex-col-reverse'>
                                    ...
                                    <motion.div
                                        ...
                                        transition={{ duration: 0.3, type: "spring", stiffness: 200, delay: 0.3 }}
                                        className='w-96 h-64 rounded-xl -ml-64 mt-16 hidden lg:block'>
                                        <img className='w-full h-full object-contain rounded-xl border-2' src={Step_4}></img>
                                    </motion.div>
                                    <motion.div
                                        viewport={{ once: true }}
                                        initial={{ opacity: 0, x: 100 }}
                                        ...
                                        <img className='w-full h-full object-contain rounded-xl' src={Step_5}></img>
                                    </motion.div>
                                    <motion.div
                                        viewport={{ once: true }}
                                        initial={{ opacity: 0, x: -50 }}
                    ...
                    <div className='flex w-screen flex-col bg-[#160923] z-0 lg:-mt-[4rem]'>
                        <div className='lg:pt-16 flex flex-col lg:flex-row items-center justify-around lg:h-3/5 w-full bg-gradient-to-tr from-purple-800 lg:pb-16'>
                            <a href={Yearbook} target="_blank"><motion.div
                                initial={{ opacity: 0, x: -50 }}
                                whileInView={{ opacity: 1, x: 0 }}
                                transition={{ duration: 0.3, type: "spring", stiffness: 100 }}
